    ...
    return (
        <View style = {styles.backgroundColor}> 
            ...
            <View style = {styles.textbox}>
                <Text style = {styles.text}> The main page previews all the photos you have saved. Swipe left and right to view. Tap on folders to check out images you saved based on different categories.</Text>
            </View>
